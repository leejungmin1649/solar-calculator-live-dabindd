      ...
      {[
        ...
        <div key={name}>
          ...
          <input
            ...
            className="bg-gray-800 text-white border border-gray-700 rounded-md p-2 w-full text-sm"
          />
        </div>
      ))}

      <div className="col-span-1 sm:col-span-2 mt-6 space-y-1 text-sm text-white">
        <h2 className="font-semibold">결과 요약</h2>
