      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        ...
        {summary && (
          <section className="space-y-6 mt-10">
            <div className="bg-gray-700 rounded-lg p-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        <section className="mt-12 text-sm text-gray-300 space-y-2 border-t border-gray-700 pt-6">
          ...
          <p className="mt-3 text-xs text-gray-500">※ 본 계산기는 추정치를 기초로 작성된 자료로、실제 수익과 차이가 발생할 수 있습니다。해당 자료는 참고용이며、법적 효력이 없습니다。</p>
        </section>
      </main>
    </div>
  );
