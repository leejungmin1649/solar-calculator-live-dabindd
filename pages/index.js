...
<header className="py-10 border-b border-gray-700">
  <div
    className="
      ...
      sm:flex-row sm:justify-between sm:items-center sm:space-y-0 sm:text-left
    "
  >
    {/* 로고 + 타이틀 */}
    <div className="flex flex-col items-center sm:flex-row sm:items-center sm:space-x-3">
      <a href="http://www.dabinenc.com" target="_blank" rel="noopener noreferrer">
        <img
          src="/logo-dabin.png"
          alt="다빈이앤씨 로고"
          className="w-32 h-auto mb-2 sm:mb-0"
        />
      </a>
      <div>
    ...
    <div className="flex flex-col items-center space-y-2 sm:flex-row sm:space-x-6 sm:space-y-0">
      ...
      <div className="flex items-center space-x-1 text-sm text-gray-300">
        ...
        <a href="tel:042-484-1108" className="underline hover:text-emerald-400">
          042-484-1108
        </a>
        <span className="ml-1">
          (태양광 투자, 토지개발, 유통, 공사, 금융, RE100 문의)
        </span>
      </div>
      {/* 블로그 */}
      <div className="flex items-center space-x-1 text-sm text-gray-300">
